    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#InsertCategory"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Adicionar nueva categoria</button>
        ...
        <div class="box-body">
            ...
            <tr>
               <th>
                 <select class="form-control" id="group_options" name="group_options">
                    <option value="" disabled selected>Acción<nav></nav> de Grupo</option>
                    <option value="delete" >Eliminar</option>
                    <option value="1">Publicar</option>
                    <option value="0">Anular Publicacion</option>
            </select>
               </th>
               <th>&nbsp;</th>
               <th>
          ...
          <table class="table table-hover">
            <tr class="info">
              ...
              <th style="text-align: center;">Estado de la Aviso</th>
            ...
            <tr class="success">
             ...
             ?>
              ...
              <?php 
                ...
                {
               ?>
              <td style="text-align: center;"><span class="label label-success">Publicar</span></td>
              <?php 
                }
                else
                {
              ...
              <td style="text-align: center;">
               ...
               <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#DeleteCategory" data-category_id_delete="<?= $view_category_id ?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Eliminar</button>
              </td>
            </tr>
            <?php
                } 
