    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#InsertComment"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Adicionar nuevo comentario</button>
        ...
        <div class="box-body">
            ...
            <tr>
               <th>
                 <select class="form-control" id="group_options" name="group_options">
                    <option value="" disabled selected>Acción de grupo</option>
               ...
               <th>
                ...
                $(document).ready(function(){
                  ...
                  <input class="col-xs-4" type="text" placeholder="Search" id="myInput" aria-label="Buscar">
              </th>
          ...
          <table class="table table-hover">
            <tr class="info">
              ...
              <th style="text-align: center;">Título del Estado</th>
              <th style="text-align: center;">Estado del Comentario</th>
            ...
            <tr class="success">
              ...
              <?php 
                ...
                {
              ?>
              <td style="text-align: center;"><span class="label label-warning">Publicación Pendiente</span></td>
              <?php
                }
              ?>
              <td style="text-align: center;">
               ...
               <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#DeleteComment" data-comment_id_delete="<?= $view_comm_id ?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Eliminar</button>
              </td>
            </tr>
            <?php
                } 
