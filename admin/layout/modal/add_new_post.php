          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header modal-header-add">
                <h4 class="modal-title" id="exampleModalLongTitle" align="center"><i class="fa fa-file"></i> Adicionar nuevo Aviso</h4>
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label for="post_title" class="col-form-label">Nombre de la Mascota:</label>
                  <input type="text" class="form-control" id="post_title" name="post_title" placeholder="Introduzca Nombre " required="">
                </div>
                <script>
//function myFunction() {
...
//}
                ...
                <div class="row">
                    <div class="col-sm-4">
                      <label for="category_id" class="col-form-label">Estado:</label>
                    ...
                    <div class="col-sm-4">
                      <label for="post_autor" class="col-form-label">Administrador / Usuario :</label>
                    ...
                    <div class="col-sm-4">
                      <label for="post_date" class="col-form-label">Fecha:</label>
                      <input type="text" class="form-control" id="post_date" name="post_date" value="<?php echo $current_date; ?>" required>
                    </div>
                  </div>
                  <div class="form-group">
                      <label for="post_imagel" class="col-form-label">Subir Imagen:</label>
                      <input type="file" name="post_image" id="post_image" accept="image/*">
                  </div>
                  <div class="form-group shadow-textarea">
                    <label for="post_text" class="col-form-label">Descripción del Aviso:</label>
                  ...
                  <div class="form-group">
                    <label for="post_tag" class="col-form-label">Lugar de Perdida:</label>
                    <input type="text" class="form-control" id="post_tag" name="post_tag">
                  </div>
                  <div class="row">
                 
                  <div class="col-sm-4">
                    <label for="post_status" class="col-form-label" >Estado de la Publicación:</label><br>
                    <input type="radio" name="post_status" id="post_status" value="1" checked=""> Publicar
                    <input type="radio" name="post_status" id="post_status" value="0"> Borrador
                  </div>
                  <div class="col-sm-2">
                    <label for="post_priority" class="col-form-label">Prioridad:</label>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" name="save_post"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Guardar</button>
              </div>
              </form>
            </div>
          </div>
