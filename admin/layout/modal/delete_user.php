  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" align="center">Eliminar Usuario</h5>
      ...
      <div class="modal-body">
        <div class="form-group">
            ...
            ¿Está seguro de que desea eliminar este usuario?</p>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal"><span class="glyphicon glyphicon-name"></span>Cerrar</button>
        <button type="submit" name="delete_user_id_btn" class="btn btn-warning"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Eliminar</button>
      </div>
      </form>
    </div>
  </div>
