          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header modal-header-warning">
                <h4 class="modal-title" id="exampleModalLongTitle" align="center">Editar comentario</h4>
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label for="cat_title_edit" class="col-form-label">Comentario:</label>
                ...
                <div class="col-sm-4">
                    <label for="comm_status_edit" class="col-form-label" >Estado:</label><br>
                    <input type="radio" name="comm_status_edit" id="comm_status_edit" value="1" checked=""> Publicar
                    <input type="radio" name="comm_status_edit" id="comm_status_edit" value="0"> Anular
                  </div>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" name="edit_comment"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Guardar</button>
              </div>
              </form>
            </div>
          </div>
