          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header modal-header-warning">
                <h4 class="modal-title" id="exampleModalLongTitle" align="center"><i class="fa fa-pencil-square-o"></i> Editar Aviso</h4>
              ...
              <div class="modal-body" id="demo" onmouseover="mouseOver(this)">
                ...
                <div class="form-group">
                  <label for="post_title_edit" class="col-form-label">Titulo del Aviso:</label>
                  <input type="text" class="form-control" id="post_title_edit" name="post_title_edit" placeholder="Introduzca titulo" required="">
                </div>
                <div class="row">
                    <div class="col-sm-4">
...
//}
                  ...
                  <div class="form-group shadow-textarea">
                    <label for="post_text_edit" class="col-form-label">Descripción:</label>
                    <textarea name="post_text_edit" id="post_text_edit" placeholder="Introduzca  Texto " required></textarea>
                  </div>
                    <script>
                       CKEDITOR.replace('post_text_edit');
                    </script>
                  <div class="form-group">
                    <label for="post_tag_edit" class="col-form-label">Lugar de Perdida:</label>
                    <input type="text" class="form-control" id="post_tag_edit" name="post_tag_edit">
                  </div>
                  <div class="row">
                  <div class="col-sm-4">
                    <label for="post_status_edit1" class="col-form-label" >Estado:</label><br>
                    <input type="radio" name="post_status_edit" value="1" checked=""> Publicar
                    <input type="radio" name="post_status_edit" value="0"> Anular
                  </div>
                  <div class="col-sm-2">
                    <label for="post_priority_edit" class="col-form-label">Prioridad:</label>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" name="edit_post"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Guardar</button>
              </div>
              </form>
            </div>
          </div>
