          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header modal-header-warning">
                <h4 class="modal-title" id="exampleModalLongTitle" align="center"><i class="fa fa-user"></i> Editar Usuario</h4>
...
//}
        ...
        <!-- /.col -->
                ...
                <div class="form-group col-md-4">
                  ...
                  <label for="cat_title" class="col-form-label"> Nombre :</label>
                ...
                <div class="form-group col-md-4">
                  <label for="cat_title" class="col-form-label"> Correo:</label>
                ...
                <div class="form-group col-md-4">
                  <label for="user_password" class="col-form-label">Vuelva a introducir su contraseña :(obligatorio)</label>
                ...
                <div class="form-group col-md-4">
                  <label for="user_password_reapet" class="col-form-label"> Repita la Contraseña :(obligatorio)</label>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="radio" name="user_status_edit" id="user_status_edit" value="1" checked=""> Activo
                    <input type="radio" name="user_status_edit" id="user_status_edit" value="0"> Pendiente
                </div>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" name="edit_user"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Guardar</button>
              </div>
              </form>
            </div>
          </div>
