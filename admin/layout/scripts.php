...
$('#EditUser').on('show.bs.modal', function (event) {
  ...
  if(type == 0) {
    document.getElementById("p1").innerHTML ='<label for="user_type" class="col-form-label"> Tipo de Usuario :</label>'+
 ...
 mouseOverUser(this);
if(gender == 1) {
    document.getElementById("p2").innerHTML ='<label for="cat_title" class="col-form-label"> Genero:</label><br>'+
