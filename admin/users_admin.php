    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#InsertUser"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Adicionar nuevo Admin / usuario</button>
          ...
          <table class="table table-hover">
            ...
            <tr class="success">
              ...
              ?>
               ...
               <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#DeleteUser" data-user_id_delete="<?= $view_users_id ?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Eliminar</button>
              </td>
            </tr>
            <?php
                } 
