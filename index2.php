  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <h1 class="my-4">Avisos de Mascotas
          <small></small>
        </h1>
        <?php 
                $no_posts_per_page = 5;
        ...
        <div class="card mb-4">
          ...
          <div class="card-footer text-muted">
            ...
            Por <a href="author.php?auth=<?= $view_users_id; ?>"><?php echo $view_users_name; ?></a> <br><a>Fecha</a>
        ...
        <ul class="pagination justify-content-center mb-4">
          <li class="page-item">
            <?php 
                ...
                ?>
            <a class="page-link" href="index.php?page=<?php echo $previous ?>">&larr; Anterior</a>
             <?php } ?>
          </li>
          <li class="page-item">
            <?php 
                if ($page < $allpages)
                  {
                    $next= $page + 1;
              ?>
            <a class="page-link" href="index.php?page=<?php echo $next ?>">Siguiente &rarr;</a>
            <?php } ?>
          </li>
        </ul>
