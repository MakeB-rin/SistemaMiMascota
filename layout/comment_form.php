    <?php
     ...
     ?> 
            ...
            <form method="post" action="" onsubmit="myFunction()">
              <div class="form-group">
                <?php 
                 ...
                 ?>
                <label for="autor" class="col-form-label">Nombre de la Persona:</label>
                ...
                <?php 
                 ...
                 <p class="lead">
                   <img src="admin/images/users/<?php echo $success_login_image_admin; ?>" class="zoom3" alt="User Image" width="50" align="left" hspace="5">
                      <a href="#"><?php echo $success_login_name_admin; ?></a> <br>  <a href="#"></a>
              ...
              <button type="submit" name="save_comment" class="btn btn-primary">enviar</button>
            </form>
        ...
        <script>
function myFunction() {
  alert("¡Tu comentario está pendiente de moderación y será visible después de que haya sido aprobado!");
