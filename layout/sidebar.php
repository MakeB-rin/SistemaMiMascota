<div class="col-md-4">
  ...
  ?>
    ...
    <div class="login-form">
      ...
      <div class="or-seperator"><i>Bienvenido</i></div>
      <div class="or-seperator"><i>Aqui puedes iniciar Sesión</i></div>
      ...
      <form action="layout/login.php" method="post">
        ...
        <div class="form-group">
          <button type="submit" name="login" class="btn btn-success btn-block login-btn">Iniciar Sesión</button>
        </div>
        <div class="clearfix">
          <label class="pull-left checkbox-inline"><input type="checkbox"> Recordarme</label>
          <a href="#" class="pull-right text-success">¿Has olvidado tu contraseña?</a>
        </div>
      </form>

      <div class="hint-text small">¿No tienes una cuenta? <a href="../layout/register.php" class="text-success">Registrate Ahora!</a></div>
    </div>
  ...
  ?>
    ...
    <div class="card my-4">
      <div class="card-header">
        ...
        <p align="center"><b>Bienvenido <?php echo $success_login_name_admin; ?></b></p>
      </div>
      <div class="card-header">
        ...
        <p align="center">
          ...
          ?>
            <a href="admin/" class="btn btn-default btn-flat">Administración</a>
          <?php
          } else {

          ?>
            <a href="admin/" class="btn btn-default btn-flat">Perfil</a>
          <?php } ?>
          <a href="layout/logout.php" class="btn btn-default btn-flat">Cerrar Sesión</a>
        </p>
      </div>
    </div>
  <?php
  ...
  <div class="card my-4">
    ...
    <div class="card-body">
      <form action="search.php" method="post">
        <div class="input-group">
          <input type="text" class="form-control" name="search_text" placeholder="Buscar ...">
  ...
  <!-- Side Widget -->
  <div class="card my-4">
    <h5 class="card-header">Avisos Populares </h5>
    <?php
    $counter_popular = 0;
