  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <h1 class="my-4">Resultados de Busqueda :
          <small></small>
        </h1>
        <?php 
                $no_posts_per_page = 5;
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <a href="post.php?postid=<?= $view_post_id; ?>" class="btn btn-primary">Detalles &rarr;</a>
          </div>
          <?php 
          ...
          <div class="card-footer text-muted">
            <img src="admin/images/users/<?php echo $view_users_image; ?>" class="zoom3" alt="User Image" width="50" align="left" hspace="5">
             <a href="#"><?php echo $view_users_name; ?></a> <br> <a href="#"></a>
        ...
        <ul class="pagination justify-content-center mb-4">
          <li class="page-item">
            <?php 
                ...
                ?>
            <a class="page-link" href="search.php?page=<?php echo $previous ?>&search=<?php echo $search_text ?>">&larr; Anterior</a>
             <?php } ?>
          </li>
          <li class="page-item">
            <?php 
                if ($page < $allpages)
                  {
                    $next= $page + 1;
              ?>
            <a class="page-link" href="search.php?page=<?php echo $next ?>&search=<?php echo $search_text ?>">Siguiente &rarr;</a>
            <?php } ?>
          </li>
        </ul>
